...
static void
show_logging_filename (GIOChannel *file, int from_tty,
...
static void
show_logging_overwrite (GIOChannel *file, int from_tty,
			struct cmd_list_element *c, const char *value)
{
...
static void
show_logging_redirect (GIOChannel *file, int from_tty,
		       struct cmd_list_element *c, const char *value)
{
...
_initialize_cli_logging (void)
{
  ...
  bosh_command_list_add_prefix ("logging", class_support, set_logging_command,
		  _("Set logging options"), &set_logging_cmdlist,
		  "set logging ", 0, &setlist);
  bosh_command_list_add_prefix ("logging", class_support, show_logging_command,
...
The logfile is used when directing GDB's output."),
			    ...
			    &set_logging_cmdlist, &show_logging_cmdlist);
  bosh_command_list_add ("on", class_support, set_logging_on,
	   _("Enable logging."), &set_logging_cmdlist);
  bosh_command_list_add ("off", class_support, set_logging_off,
