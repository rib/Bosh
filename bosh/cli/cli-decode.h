...
struct cmd_list_element
{
  ...
  /* Function definition of this command.  NULL for command class
     ...
     the moment suggest sticking with either bosh_command_set_callback() or
     bosh_command_set_setshow_callback().  */
...
struct cmd_list_element *bosh_add_command (char *, enum command_class,
                                  void (*fun) (char *, int), char *);

struct cmd_list_element *bosh_add_command_alias (char *, char *,
                                        enum command_class, int);

struct cmd_list_element *bosh_add_info_command (char *, void (*fun) (char *, int),
                                   char *);

struct cmd_list_element *bosh_add_info_alias_command (char *, char *, int);

char **complete_on_cmdlist (struct cmd_list_element *, char *, char *);

char **complete_on_enum (const char *enumlist[], char *, char *);

void delete_cmd (char *, struct cmd_list_element **);

void help_cmd_list (struct cmd_list_element *, enum command_class,
                    char *, int, GIOChannel *);

/* Functions that implement commands about CLI commands. */

void help_cmd (char *, GIOChannel *);

void help_list (struct cmd_list_element *, char *,
                enum command_class, GIOChannel *);

void apropos_cmd (GIOChannel *stream,
...
void print_doc_line (GIOChannel *, char *);
